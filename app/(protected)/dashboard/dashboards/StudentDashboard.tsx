...
const StudentPerformanceChart = dynamic(
  () => import('./components/StudentPerformanceChart').then((mod) => mod.StudentPerformanceChart),
  {
    ssr: false,
    loading: () => (
      <div className="h-[250px] w-full rounded-md bg-muted/40 animate-pulse" />
    ),
  }
);
      ...
      <motion.div variants={item} className="grid gap-6 lg:grid-cols-2">
         ...
         >
            ...
            {semesterGrades.length > 0 ? (
              <StudentPerformanceChart semesterGrades={semesterGrades} />
            ) : (
