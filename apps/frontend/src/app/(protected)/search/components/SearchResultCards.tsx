...
export function UserCard({ user }: { user: any }) {
  ...
  return (
    <Card className="hover:border-border/40 transition-colors cursor-pointer" onClick={() => router.push(`/directory/users/${user.id}` as any)}>
...
export function PageCard({ page }: { page: any }) {
  ...
  return (
    <Card className="hover:border-border/40 transition-colors cursor-pointer group" onClick={() => router.push(page.path as any)}>
      <CardContent className="p-4 flex items-center gap-3">
...
export function SubjectCard({ subject }: { subject: any }) {
  const router = useRouter();
  return (
    <Card className="hover:border-border/40 transition-colors cursor-pointer group" onClick={() => router.push(`/courses`)}>
      <CardContent className="p-4 flex items-center gap-3">
