        ...
        <div className="space-y-6">
           <div className="card-elevated p-6">
              ...
              <div className="grid gap-2">
                 {enrollments.map(e => (
                   <div key={e.id} className="p-3 border rounded-sm flex justify-between items-center">
           ...
           <div className="card-elevated p-6">
              ...
              <div className="grid gap-2">
                 {grades.map(g => (
                   <div key={g.id} className="p-3 border rounded-sm flex justify-between items-center">
