...
import TimetableFilters, { type TimetableFilterValues } from "@/features/timetable/TimetableFilters";
    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div className="hidden md:flex flex-wrap items-center gap-2">
          ...
          >
            {isWeeklyView ? <List className="h-3.5 w-3.5" /> : <Calendar className="h-3.5 w-3.5" />}
            {isWeeklyView ? "Today Only" : "Full Week Grid"}
          </Button>
            ...
            <>
              ...
              >
                {generating ? (
                  ...
                  <><Calendar className="w-3.5 h-3.5" />Auto Generate</>
                )}
              </Button>
              <Button variant="outline" size="sm" className="gap-2 font-semibold text-xs" onClick={() => setShowBulkUpload(true)}>
          ...
          {canScheduleExtraClass && (
            <Button variant="outline" size="sm" className="gap-2 font-semibold text-xs" onClick={() => setShowExtraClassDialog(true)}>
              <Plus className="w-3.5 h-3.5" />
              Extra Class
            </Button>
          )}
          <Button variant="outline" size="sm" className="gap-2 font-semibold text-xs" onClick={exportTimetable}>
                        ...
                        <div className="flex-1">
                          {data.map((s: any, i: number) => (
                            <div key={i} className="text-xs">
                              <p className="font-bold text-foreground line-clamp-1">{s.courseCode || s.courseName}</p>
                              ...
                              >
                                ...
                                {slot.room && (
                                  ...
                                  >
                                    ...
                                    <span className="opacity-0 group-hover:opacity-100 transition-opacity">→ MAP</span>
                                  </button>
                                )}
