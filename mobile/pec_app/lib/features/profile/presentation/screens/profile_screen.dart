...
class _ProfileHeroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(AppDimensions.lg),
      decoration: BoxDecoration(
        color: const Color(0xFF1F180F),
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        border: Border.all(color: AppColors.yellow.withValues(alpha: 0.28), width: 1.2),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Icon(Icons.location_on_outlined,
                  color: AppColors.yellow.withValues(alpha: 0.95), size: 22),
              const SizedBox(width: AppDimensions.sm),
              Flexible(
                child: Text(
                  campus,
...
class _ProfileActionButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bgColor = filled ? AppColors.yellow : Colors.transparent;
    final fgColor = filled ? AppColors.black : AppColors.yellow;
    ...
    return Material(
      ...
      child: InkWell(
        ...
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        child: Ink(
          height: AppDimensions.minTouchTarget + 6,
          decoration: BoxDecoration(
            color: bgColor,
            borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
            border: Border.all(color: AppColors.yellow.withValues(alpha: 0.8), width: 1.2),
          ),
          child: Center(
            child: Text(
              label,
