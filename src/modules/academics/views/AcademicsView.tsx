  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black font-monument uppercase tracking-tight">Academic Registry</h1>
          ...
          <div key={label} className="card-elevated p-6 border-b-4 border-r-4 border-primary/10">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-4xl font-black font-monument mt-1">{value}</p>
              </div>
            </div>
          </div>
        ))}
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div className="space-y-2">
                  ...
                  <h3 className="font-black text-xl leading-tight uppercase font-monument tracking-tight">{course.name}</h3>
                </div>
                {isAdmin && (
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="max-w-lg rounded-sm border-2 border-primary shadow-[20px_20px_0px_rgba(0,0,0,0.05)]">
          <DialogHeader className="space-y-3">
            <DialogTitle className="text-3xl font-black font-monument uppercase">{editingCourse ? 'Modify Course Node' : 'Initialize Course Node'}</DialogTitle>
