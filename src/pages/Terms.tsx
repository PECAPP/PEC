        ...
        >
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using the OmniFlow website and application, you accept and agree to be bound by the terms
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              OmniFlow's website for personal, non-commercial transitory viewing only. This is the grant of a license, not
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The materials on OmniFlow's website are provided "as is". OmniFlow makes no warranties, expressed or
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              For any questions about these Terms, please contact us at legal@omniflow.app
            </p>
          </section>
        </motion.div>
      </div>
