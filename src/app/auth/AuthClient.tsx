        ...
        >
          ...
          <div className="relative group">
            <div className="flex items-baseline">
              <span className="text-8xl md:text-[10rem] font-bold font-monument tracking-tight text-accent leading-none">P</span>
              <div className="relative">
                ...
                />
                <span className="text-8xl md:text-[10rem] font-bold font-monument tracking-tight text-accent leading-none">E</span>
              </div>
              <span className="text-8xl md:text-[10rem] font-bold font-monument tracking-tight text-accent leading-none">C</span>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-20 bg-background relative overflow-y-auto">
        ...
        >
          <div className="mb-14 text-center md:text-left">
            <h2 className="text-4xl font-bold font-monument tracking-tight uppercase text-foreground leading-none mb-6">
            ...
            <TabsContent value="signup" className="mt-0 animate-in fade-in slide-in-from-bottom-2 duration-500">
              <div className="bg-muted/80 border border-border p-12 text-center space-y-8 rounded-sm shadow-inner">
                 ...
                 <div className="space-y-2">
                   <h3 className="text-xl font-bold font-monument uppercase tracking-tight">Identity Protected</h3>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-background/90 backdrop-blur-md animate-in fade-in duration-500">
          ...
          >
            <div className="bg-primary text-primary-foreground px-8 py-10 relative">
              <h2 className="text-3xl font-bold font-monument uppercase tracking-tight">System Persona</h2>
