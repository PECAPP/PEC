...
const coreModules = [
  ...
  },
  {
    ...
    description:
      "Comprehensive management of courses, departments, and faculty performance.",
  },
];
...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Secure access control for admins, faculty, and students with tailored dashboards.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 px-6">
        ...
        >
          ...
          >
            PEC combines student management, academics, finance, and attendance
            into a unified system designed for modern educational
            institutions.
          </motion.p>
        </motion.div>
      </section>
