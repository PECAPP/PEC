                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <div className="sm:block hidden">
                    <span className="text-xs text-muted-foreground">
                      {selectedRoom.type === "general" && "Public Community"}
                      {selectedRoom.type === "semester" && `Semester ${selectedRoom.semester}`}
                      {selectedRoom.type === "department" && `${selectedRoom.department} Dept`}
